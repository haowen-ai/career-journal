...
const copy = {
  en: {
    ...
    submitted: 'Submitted', draft: 'Draft', verified: 'Verification', checksum: 'SHA-256', results: (visible, total) => `${visible} of ${total}`,
  ...
  'zh-CN': {
    ...
    verified: '验证状态', checksum: 'SHA-256', results: (visible, total) => `显示 ${visible} / ${total} 条`,
